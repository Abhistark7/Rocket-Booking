...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="select_payload_rocket.css">
    ...
    <div class="redTab">
        <h1 class="book_text_heading">BOOK A  ROCKET &nbsp;&nbsp;&nbsp; >  &nbsp;&nbsp;&nbsp; Payload delivery to orbit &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;Select rocket</h1>
    </div>
        
    <div class="container">
        
        <h1 class="select_heading">Select Rocket and Payload capacity</h1>
        ...
        <form action="connPayloadRocket.php" method="post">
        ...
        <h2 class="seats_text">Select Payload Capacity</h2>
            
        <select class="select_val" name="select_val">
        <option value="1000kgs">1000kgs</option>
        <option value="2000kgs">2000kgs</option>
        <option value="3000kgs">3000kgs</option>
        <option value="4000kgs">4000kgs</option>
        </select>
